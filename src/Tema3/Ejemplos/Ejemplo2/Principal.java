...
public class Principal {
    ...
    private static ObjectContainer abrirBd() {
        ...
        return Db4oEmbedded.openFile(config, BD_PERSONAS);
    }
    ...
    private static void tratarOpcion(int opc) {
        ...
        switch (opc) {
            ...
            case 4 -> insertarCoche();
            case 5 -> borrarPersona();
        }
    }
    ...
    private static Persona crearPersona() {
        return new Persona(solicitarNombre(), solicitarEdad());
    }
